  ...
  try {
    ...
    const perplexityMessages = [
      { role: "system", content: "You are an expert at recommending trip suggestions matching certain user preferences" },
      {
        ...
        - The places should be perfectly aligned with the given trip details and preferences.
        - The given examples should be as diverse as possible and should include places from different
        countries and enable doing different activities, still aligning with the preferences. 
...
export const fetchPerfectMatch = async (tripId) => {
  try {
    ...
    // Gather all preferences and swipes from Firestore   // TODO also include trip details @Phi Linh
